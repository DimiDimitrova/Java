...
public enum Country {
    ...
    GUYANA("Guyana"),
    HAITI("Haiti"),
    HEARD_ISLAND_MC_DONALD_ISLANDS("Heard and Mc Donald Islands"),
    HONDURAS("Honduras"),
    HONG_KONG("Hong Kong"),
    HUNGARY("Hungary"),
    ICELAND("Iceland"),
    ...
    KOREA_DEMOCRATIC_PEOPLE_REPUBLIC("Korea (Democratic People's Republic of)"),
    ...
    MART_MARTINIQU_ENIQUE("Martinique"),
    ...
    SURINAME("Suriname"),
    ST_HELENA("St. Helena"),
    ST_MARTIN("St. Martin (French part)"),
    ST_PIERRE_MIQUELON("St. Pierre and Miquelon"),
    SVALBARD_JAN_MAYEN("Svalbard and Jan Mayen Islands"),
    SWAZILAND("Swaziland"),
    SWEDEN("Sweden"),
